...
The evidence-layer update prioritizes Tokyo Metropolitan Government tsunami damage estimation as the primary Chuo evidence candidate. Current P8-C gate is `CONDITIONAL PASS`: official metropolitan tsunami evidence is identified, but exact spatial extraction remains manual/pending and the current boundary/depth is prototype/manual, not a final official inundation surface.
