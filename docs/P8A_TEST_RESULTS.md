...
| P8-A compatibility preflight | PASS | `tools/p8/run_p8a_compat_preflight.ps1` passed after integration; high-detail scene exists, P8 has exactly five stages, hazard data exists, P2-P6 compatibility docs exist, and ProjectSettings/Packages are clean. |
