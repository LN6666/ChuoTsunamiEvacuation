...
Public references report Chuo maximum tsunami height values around 2.4m to 2.46m, depending on source/scenario. P8-B records:
...
P8-B may proceed as official metropolitan evidence-planned / manual-extraction-required. It must not claim a complete official Chuo inundation-depth raster or polygon layer unless the spatial layer is actually extracted and reviewed.
