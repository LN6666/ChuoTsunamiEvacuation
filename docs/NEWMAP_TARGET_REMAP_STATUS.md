...
- Active runtime targets: 3 local non-official training proxies.
...
Active local proxies are used only for mechanics validation and are explicitly non-official.
