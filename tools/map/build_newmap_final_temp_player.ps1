...
$LogPath = Join-Path $ProjectRoot "Logs\newmap_final_temp_build.log"
$BuildPath = "D:\UnityProjects\ChuoTsunamiEvacuation-Builds\NewMapFinalPre\ChuoTsunamiEvacuation_NewMapFinalPre.exe"
...
$arguments = @(
    ...
    "-executeMethod", "NewMapSceneSetupUtility.BuildNewMapFinalTempPlayerCommandLine",
    "-logFile", $LogPath
)

Write-Host "Starting final temporary NewMap player build. Log: $LogPath"
...
$result = [ordered]@{
    ...
    note = "Temporary manual-test build only. This is not a final release package."
}
...
Write-Host "[PASS] Final temporary NewMap player build completed: $BuildPath"
exit 0
