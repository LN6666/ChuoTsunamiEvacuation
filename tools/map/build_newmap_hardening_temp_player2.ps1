...
$LogPath = Join-Path $ProjectRoot "Logs\newmap_hardening_temp_build2.log"
$BuildPath = "D:\UnityProjects\ChuoTsunamiEvacuation-Builds\NewMapHardeningPre2\ChuoTsunamiEvacuation_NewMapHardeningPre2.exe"
...
$arguments = @(
    ...
    "-executeMethod", "NewMapSceneSetupUtility.BuildNewMapHardeningTempPlayer2CommandLine",
    "-logFile", $LogPath
)

Write-Host "Starting hardening Pre2 temporary NewMap player build. Log: $LogPath"
...
$result = [ordered]@{
    ...
    note = "Temporary hardening Pre2 build only. This is not a final release package."
}
...
Write-Host "[PASS] Hardening Pre2 temporary NewMap player build completed: $BuildPath"
exit 0
