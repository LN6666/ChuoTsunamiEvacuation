...
public static class NewMapSceneSetupUtility
{
    ...
    public static void BuildNewMapNoMemoryFocusPlayerCommandLine()
    {
    ...
    public static void BuildNewMapGameplaySelfAuditPlayerCommandLine()
    {
    ...
    public static void BuildNewMapVisualRound2PlayerCommandLine()
    {
    ...
    public static void BuildNewMapGroundVisualRound3PlayerCommandLine()
    {
    ...
    public static void BuildNewMapBuildingSnapNpc100xPlayerCommandLine()
    {
    ...
    public static void BuildNewMapNameEnrichmentPlayerCommandLine()
    {
    ...
    public static void BuildNewMapRuntimeNpcLabelPlayerCommandLine()
    {
